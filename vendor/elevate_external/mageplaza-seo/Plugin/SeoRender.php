...
class SeoRender {
    ...
    public function getElevateCanonical() {
        ...
        $landing_page = $this->registry->registry('elevate_landingpage_data');

        //$elevate_general_helper = Mage::helper('elevate_general');
        $can_link = '';

        if ($landing_page) {
            if (isset($landing_page['canonical_url'])) {
                $canonical_landing = $landing_page['canonical_url'];
            }
        }
