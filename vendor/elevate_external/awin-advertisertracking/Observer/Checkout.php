...
class Checkout implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function get_server_to_server_url($order, $awc, $channel)
    {
        ...
        $p1 = 'magento2Module_1.0.2';

        return "https://awin1.com/sread.php?tt=ss&tv=2&cks={$awc}&merchant={$advertiserId}&amount={$totalAmount}&ch={$channel}&cr={$currency}&parts=DEFAULT:{$totalAmount}&ref={$orderId}&vc={$voucher}&p1={$p1}";
    }
