...
class Config
{
     ...
     * @return bool|int
     */
    public function getApproveLocalComments($store = null)
    {
        return $this->scopeConfig->getValue('kb/comments/approve_local_comments', ScopeInterface::SCOPE_STORE, $store);
    }
}
