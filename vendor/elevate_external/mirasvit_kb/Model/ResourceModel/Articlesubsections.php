...
class Articlesubsections extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
    ...
    {
        $this->_init('mst_kb_articlesubsections', 'articlesubsection_id');
    }
    ...
    /**
     * @param AbstractModel|\Mirasvit\Kb\Model\Article $article
     * @return \Mirasvit\Kb\Model\Article
     */
    protected function loadCustomerCategoryIds($article)
    {
        $select = $this->getConnection()->select()
    ...
    /**
     * @param AbstractModel|\Mirasvit\Kb\Model\Article $object
     * @return $this
     */
    ...
    {
        /** @var \Mirasvit\Kb\Model\Articlesubsections $object */
    ...
    protected function _afterSave(AbstractModel $object)
    {
       ...
       // $this->saveCustomerCategoryIds($object);
        ...
        //$condition = $this->getConnection()->quoteInto('type = "ARTICLE" AND module = "KBASE" AND entity_id = ?', $object->getId());
       // $this->getConnection()->delete($this->getTable('mst_core_urlrewrite'), $condition);
        /*
        ...
        /*
            foreach ($categories as $category) {
                ...
                $categoryKey = '';
                if (($categories->count() == 1) && (!$this->config->getCategoryURLExcluded())) {
