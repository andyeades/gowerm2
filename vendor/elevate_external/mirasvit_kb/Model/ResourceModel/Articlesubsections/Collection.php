    ...
    \Magento\Framework\Option\ArrayInterface
{
     ...
     * @var string
     */
    protected $_idFieldName = 'articlesubsection_id';//@codingStandardsIgnoreLine
    ...
    /**
     * @var \Mirasvit\Kb\Model\ResourceModel\Articlesubsections\CollectionFactory
     */
     ...
     * @param CollectionFactory $articlesubsectionsCollectionFactory
    ...
    public function __construct(
        ...
        CollectionFactory $articlesubsectionsCollectionFactory,
    ...
    {
        $this->_init('Mirasvit\Kb\Model\Articlesubsections', 'Mirasvit\Kb\Model\ResourceModel\Articlesubsections');
    }
    ...
    {
        return $this->_toOptionArray('articlesubsection_id', 'name');
    }
    ...
    public function getSearchInstance()
    {
        ...
        $search->setSearchableAttributes([
            'main_table.article_id'       => ['priority' => 0, 'selectStatement' => 'main_table.article_id'],
        ...
        $search->setPrimaryKey('articlesubsection_id');
