...
class Save extends \Mirasvit\Kb\Controller\Adminhtml\Articlesubsections
{
    /**
     * {@inheritdoc}
    ...
    public function execute()
    {
        if ($data = $this->getRequest()->getParams()) {
            ...
            try {
                $model->save();
                $this->messageManager->addSuccessMessage(__('Article Section was successfully saved'));
        ...
        $this->messageManager->addErrorMessage(__('Unable to find article section to save'));
        $this->_redirect('*/*/');
    }
}
