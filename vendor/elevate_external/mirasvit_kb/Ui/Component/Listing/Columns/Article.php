 ...
 * Class Article
 */
class Article extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
     * @var mixed
     */
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                $article->getResource()->load($article, $item[$fieldName]);
                if (isset($item[$fieldName])) {
                    $item[$fieldName] = $article->getId() ? $article->getName() : __('Article does not exist');
                }
            }
        }
