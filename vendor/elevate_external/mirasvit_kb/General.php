...
class General extends \Magento\Backend\Block\Widget\Form {
    ...
    /**
     * @var \Mirasvit\Kb\Helper\Form\Article\Storeview
     */
    ...
    private $formFactory;
    /**
     * @var \Mirasvit\Kb\Helper\Form\Article
     */
    private $articleFormHelper;
    /**
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField(
            'article_header_image', 'image', [
                                      'name'     => 'article_header_image',
                                      'label'    => __('Article Header Image'),
                                      'title'    => __('Article Header Image'),
                                      'after_element_html' => '
                           <img width="500" src="'.$article->getMediaUrl().$article->getArticleHeaderImage().'" id="theme_preview_image" />'
                                  ]
        );
