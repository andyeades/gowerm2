...
class Toolbar extends \Magento\Framework\View\Element\Template
{
     ...
     * @var bool
     */
    private $_paramsMemorizeAllowed;
    ...
    public function getWidgetOptionsJson(array $customOptions = [])
    {
        ...
        if ($this->getSearchQuery()) {
            $options['directionDefault'] = 'desc';
            $options['orderDefault'] = 'search_prior';
        }
    ...
    private function loadAvailableOrders()
    {
        if ($this->availableOrder === null) {
            ...
            if ($this->getSearchQuery()) {
                $this->availableOrder['search_prior'] = __('Relevance');
            }
        }
