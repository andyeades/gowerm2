...
class General extends \Magento\Backend\Block\Widget\Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('article_header_image', \Mirasvit\Kb\Block\Adminhtml\Renderer\Image::class, [
            'name'  => 'article_header_image',
            'label' => __('Article Header Image'),
            'title' => __('Article Header Image'),
            'path'  => $this->imageHelper->getBaseMediaPath(Image::TEMPLATE_MEDIA_TYPE_ARTICLE),
            'note'  => __('')
        ]);
