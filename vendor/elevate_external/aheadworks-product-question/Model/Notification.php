...
class Notification extends \Magento\Email\Model\Template
{
     ...
     */
    public function addToQueue($recipientName, $recipientEmail, $notificationType, $variables, $store, $email_override = false, $name_override = false)
    {                                                               
        ...
        ;           
                ...
                if($email_override){
                  $email_sender = $email_override;
                }      
                
                 $email_name = $this->scopeConfig->getValue(
        ...
        $queueModel
            ...
            ->setSubject('')
            ->setBody('')
            ->setSenderName($email_name)
            //elevate_edit
            ->setSenderEmail($email_sender)
            ->setCreatedAt(
