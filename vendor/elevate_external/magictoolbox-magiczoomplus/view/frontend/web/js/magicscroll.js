window.MagicScroll = (function() {
            ...
            L.browser.fullScreen = {
                ...
                request: function(V, W) {
                    ...
                    if (this.capable) {
                        ...
                        (V.requestFullscreen || V[L.browser.domPrefix + "RequestFullscreen"] || V[L.browser.domPrefix + "RequestFullScreen"] ||
                            function() {}).call(V)
                    } else {
                        if (W.fallback) {
                            W.fallback()
                ...
                cancel: (document.exitFullscreen || document.cancelFullScreen || document[L.browser.domPrefix + "ExitFullscreen"] || document[L.browser.domPrefix + "CancelFullScreen"] ||
    ...
    var o;
    var p = function() {
        return "mgctlbxN$MSC mgctlbxV$" + "v2.0.44".replace("v", "") + " mgctlbxL$" + "t".toUpperCase() + ((window.mgctlbx$Pltm && "string" == v.jTypeOf(window.mgctlbx$Pltm)) ? " mgctlbxP$" + window.mgctlbx$Pltm.toLowerCase() : "")
    };
    ...
    b.prototype = {
        ...
        addFullscreenEvent: function() {
            ...
            var F = this.container.querySelectorAll("iframe");
            v.$A(F).jEach(j(function(G) {
                j(G).jAddEvent(v.browser.fullScreen.prefix + v.browser.fullScreen.changeEventName, j(function(H) {
                    H.stop();
                    this.fullscreenChanged = false;
        ...
        _initDragOnScroll: function() {
            ...
            if (typeof v.browser.ieMode != "undefined") {
        ...
        dispose: function() {
            ...
            v.$A(this.container.querySelectorAll("iframe")).jEach(j(function(F) {
                F.jRemoveEvent("iframe")
            }).jBind(this));
            this.items.jEach(j(function(F) {
    ...
    v.extend(B.prototype, {
        ...
        setContainerSize: function() {
            ...
            if (this.o("height") != "auto") {
                if (this.originalClasses == "MagicScroll") {
                  console.log('not setting height aha!');
