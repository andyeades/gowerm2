...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @return array
     */
    public function getCategoryDataForServer()
    {
        $d = [];
     ...
     * @return array
     */
    public function getOrderDataForServer()
    {
     ...
     * @return array|null
     */
    public function getQuoteDataForServer()
    {
     ...
     * @return array
     */
    public function getSearchDataForServer()
    {
    ...
    public function getDataForServerCompleteRegistrationEvent($customerId = 0)
    {
        ...
        $data['data'][0]['event_name'] = $eventName;
        $data['data'][0]['event_time'] = time();
        $data['data'][0]['event_id']   = $this
            ->generateEventId($eventName, 1, 'customer');
        
        // Optional
        $data['data'][0]['event_source_url'] = $this->getCurrentUrl();
        
        $data['data'][0]['user_data']   = $userData;
        $data['data'][0]['custom_data'] = $customData;
        
        // Optional
        $data['data'][0]['opt_out'] = false;
