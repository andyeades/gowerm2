...
interface PostInterface
{
    ...
    const SIDEBARCATEGORYPRODUCTSID = 'sidebarcategoryproductsid';
    ...
    const ATTRIBUTES = [
        ...
        self::TAG_IDS,
        self::TOPIC_IDS,
        self::SIDEBARCATEGORYPRODUCTSID
    ];
    ...
    /**
     * Get Sidebar Category Id
     *
     * @return int/null
     */
    public function getSidebarcategoryproductsid();

    /**
     * Set Sidebar Category Id
     *
     * @param int $id
     *
     * @return $this
     */
    public function setSidebarcategoryproductsid($id);
}
