...
class Listpost extends Frontend
{
    ...
    public function getPostCollectionHome()
    {
        $collection = $this->getCollection();
    ...
    public function getCategoryInfo($category_id) {
        ...
        $categoryInfo = $this->helperData->getObjectByParam($category_id, null, 'category');

        return $categoryInfo;
    }

    public function getCategoryPostCollection($category_id)
    {

        $collection = $this->helperData->getPostCollection('category', $category_id, $this->store->getStore()->getId());
