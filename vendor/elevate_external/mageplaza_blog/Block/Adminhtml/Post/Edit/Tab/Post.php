...
class Post extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('sidebarcategoryproductsid', 'text', [
            'name'     => 'sidebarcategoryproductsid',
            'label'    => __('Sidebar Products Category ID'),
            'title'    => __('Sidebar Products Category ID'),
            'required' => true
        ]);
