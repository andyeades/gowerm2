...
define([
    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _RenderCustomOptions: function () {
            ...
            var $customOptionInput = $widget.productForm.find('.product-custom-options-' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId);
            $customOptionInput.empty();
            if ($($widget.options.productSelector).prop('checked')) {
                $customOptionInput.append($widget.options.customOptions[$widget.options.selectedProduct]);
            } else {
                $('.product-custom-options-' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId).children().unbind();
            }
        },
            ...
            if ($widget.options.jsonConfig.productId) {
                $.ajax({
                    ...
                    success   : function (response, widget) {
                        $('.product-custom-option-' + optionId + '-' + $widget.options.jsonConfig.productId).on('change', function () {
                            var customOptionsPrice = [];
                            function getSum(total, num) {
                                return total + num;
                            }

                            $('.product-custom-option-' + optionId + '-' + $widget.options.jsonConfig.productId).each(function (key, el) {
                            ...
                            $('.field.date-' + optionId + '-' + $widget.options.jsonConfig.productId).each(function () {
                                var allDateValues = [];
        ...
        _OnClick: function ($this, $widget) {
            ...
            if (typeof(linkedAttributes) != 'undefined' && linkedAttributes.indexOf(attributeId) != -1) {
                $.each($('div[attribute-id =' + attributeId + ']'), function() {
                    if ($('div[attribute-id =' + attributeId +'] div[option-id =' + $this.attr('option-id') + ']').length > 0) {
                        $('div[data-role=swatch-options-' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId + '] div[attribute-id =' + attributeId + ']').attr('option-selected', $this.attr('option-id'));
                    }
                ...
                $.each($('.disabled'), function(index, el) {
             ...
             */
                ...
                if (simpleProductId) {
                    $('.icp-label-option-' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId).html($widget.options.jsonConfig.customAttributes[simpleProductId].name.value);
                    $.each($widget.options.jsonConfig.images[simpleProductId], function() {
                        if (this.isMain) {
                            $('#img-option-' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId).attr('src', this.thumb);
                            return false;
                        }
                    });
                }
        ...
        _updateAddToWishlistButton: function (attributeId, attributeOptionId, $widget) {
            ...
            variationData[$widget.options.jsonConfig.productId] = attributesData;
            optionData[$widget.options.optionId] = variationData;
            ...
            if (typeof (params.data['super_attribute']) == 'undefined') {
                ...
                if (typeof(superAttribute[$widget.options.optionId]) == 'undefined') {
                    superAttribute[$widget.options.optionId] = variationData;
                } else if (typeof(superAttribute[$widget.options.optionId][$widget.options.jsonConfig.productId]) == 'undefined') {
                    superAttribute[$widget.options.optionId][$widget.options.jsonConfig.productId] = attributesData;
                } else {
                    superAttribute[$widget.options.optionId][$widget.options.jsonConfig.productId][attributeId] = attributeOptionId;
                }
        ...
        _OnChange: function ($this, $widget) {
            ...
            if (linkedAttributes.indexOf(attributeId) != -1) {
            ...
            $(el).each(function (key, element) {
                ...
                if (selection && $widget.options.multiJsonConfig[selection]) {
                    ...
                    if (selectionData.prices && $widget.options.isFixedPrice == 0) {
                        ...
                        if (typeof($widget['resultBefore_' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId]) == 'undefined') {
                            $widget['resultBefore_' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId] = JSON.parse(JSON.stringify(selectionData.prices.finalPrice.amount));
                        } else {
                            selectionData.prices.finalPrice.amount = null;
                            selectionData.prices.finalPrice.amount = JSON.parse(JSON.stringify($widget['resultBefore_' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId]));
                        }
                        ...
                        prices['bundle-option-' + $(element).attr('name') + '##' + $widget.options.selectedProduct] = result;
                        if ($product.find('[data-role=bundle-summary-price-' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId + ']')[0]) {
                            $product.find('[data-role=bundle-summary-price-' + $widget.options.optionId + '-' + $widget.options.jsonConfig.productId + ']')[0].innerHTML = mageTemplate($.trim(selectionData.template), {
                                data: {
