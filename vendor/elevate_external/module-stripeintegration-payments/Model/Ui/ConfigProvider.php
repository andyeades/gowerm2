...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        if ($this->config->isEnabled())
        {
            ...
            $data['trialingSubscriptions'] = ($this->config->isSubscriptionsEnabled() ? $this->helper->getTrialingSubscriptionsAmounts() : null);
            $data['useSetupIntents'] = $this->setupIntent->shouldUseSetupIntents();
            $data['setupIntentClientSecret'] = $this->setupIntent->createForCheckout();
            $data['prapi_description'] = $this->config->getPRAPIDescription();
        }
