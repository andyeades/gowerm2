...
class Data extends \Magento\ConfigurableProduct\Helper\Data
{
    ...
    protected $configProductBlock;

    /**
     * Data constructor.
     *
     * @param \Magento\Catalog\Helper\Image     $imageHelper
     * @param \Amasty\Xnotif\Helper\Data        $helper
     * @param \Magento\Framework\Registry       $registry
     * @param \Magento\Framework\Module\Manager $moduleManager
     * @param \Magento\ConfigurableProduct\Block\Product\View\Type\Configurable $configProductBlock
     */
    ...
    public function __construct(
        ...
        \Magento\ConfigurableProduct\Block\Product\View\Type\Configurable $configProductBlock
    ) {
        ...
        $this->configProductBlock = $configProductBlock;
    }
     ...
     * @return array
     */
    public function afterGetOptions($currentProduct,
                                    $result, $allowedProducts)
    {
        $options = [];
        $aStockStatus = [];
        $allowAttributes = $this->configProductBlock->getAllowAttributes($currentProduct);
        $something = $allowedProducts;

        $allowedProducts = $this->configProductBlock->getAllowProducts();
        ...
        //$aStockStatus['is_in_stock'] = $product
