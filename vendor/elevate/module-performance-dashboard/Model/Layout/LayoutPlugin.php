...
namespace Elevate\PerformanceDashboard\Model\Layout;
...
class LayoutPlugin
{
    ...
    /** @var \Elevate\PerformanceDashboard\Logger\Logger */
    private $logger;
     ...
     * @param \Elevate\PerformanceDashboard\Logger\Logger $logger
     */
    public function __construct(
        \Magento\PageCache\Model\Config $config,
        \Magento\Framework\App\RequestInterface $request,
        \Magento\Framework\Filesystem\DirectoryList $directoryList,
        \Elevate\PerformanceDashboard\Logger\Logger $logger
    ) {
        $this->config = $config;
