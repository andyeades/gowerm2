...
namespace Elevate\PerformanceDashboard\Model\ResourceModel\Grid;
 ...
 *
 * @package Elevate\PerformanceDashboard\Model\ResourceModel\Grid
 */
class Collection extends \Magento\Framework\Data\Collection
{
    /** @var \Elevate\PerformanceDashboard\Model\DashboardRowFactory */
    private $rowFactory;
     ...
     * @param \Elevate\PerformanceDashboard\Model\DashboardRowFactory $rowFactory
    ...
    public function __construct(
        ...
        \Elevate\PerformanceDashboard\Model\DashboardRowFactory $rowFactory,
    ...
    public function loadData($printQuery = false, $logQuery = false)
    {
        if (!$this->isLoaded()) {
            ...
            $this->addItem($this->rowFactory->create('AndyEades'));
