...
namespace Elevate\PerformanceDashboard\Model\DashboardRow;
 ...
 *
 * @package Elevate\PerformanceDashboard\Model\DashboardRow
 */
class NonCacheableLayouts extends \Elevate\PerformanceDashboard\Model\DashboardRow implements
    \Elevate\PerformanceDashboard\Model\DashboardRowInterface
{
    /** @var \Magento\Framework\Filesystem\DirectoryList */
    private $directoryList;

    /** @var \Elevate\PerformanceDashboard\Logger\Handler */
    private $logHandler;
     ...
     * @param \Elevate\PerformanceDashboard\Logger\Handler $logHandler
     * @param \Magento\Framework\Filesystem\File\ReadFactory $readFactory
     * @param array $data
     */
    public function __construct(
        \Magento\Framework\Filesystem\DirectoryList $directoryList,
        \Elevate\PerformanceDashboard\Logger\Handler $logHandler,
