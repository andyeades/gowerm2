...
namespace Elevate\PerformanceDashboard\Block\Backend\Dashboard\Grid\Column;
 ...
 *
 * @package Elevate\PerformanceDashboard\Block\Backend\Dashboard\Grid\Column
 */
class Statuses extends \Magento\Backend\Block\Widget\Grid\Column
{
    ...
    public function decorateStatus($value, $row, $column, $isExport)
    {
        ...
        $severity = [
            \Elevate\PerformanceDashboard\Model\DashboardRow::STATUS_OK => 'notice',
            \Elevate\PerformanceDashboard\Model\DashboardRow::STATUS_WARNING => 'minor',
            \Elevate\PerformanceDashboard\Model\DashboardRow::STATUS_PROBLEM => 'critical',
            \Elevate\PerformanceDashboard\Model\DashboardRow::STATUS_UNKNOWN => 'minor'
        ];
