...
namespace Elevate\LinkedProducts\Model\CatalogImportExport\Import;
...
class Product extends \Magento\CatalogImportExport\Model\Import\Product
{
    ...
    protected $_linkNameToId = [
        ...
        '_linkedproducts_' => \Elevate\LinkedProducts\Model\Catalog\Product\Link::LINK_TYPE_LINKEDPRODUCTS
    ];
    ...
    protected $_fieldsMap = [
        ...
        '_linkedproducts_sku' => 'linkedproducts_skus',
        '_linkedproducts_position' => 'linkedproducts_position',
    ];
