...
namespace Elevate\LinkedProducts\Setup;
...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $data = [
            ['link_type_id' => \Elevate\LinkedProducts\Model\Catalog\Product\Link::LINK_TYPE_LINKEDPRODUCTS, 'code' => 'linkedproducts']
        ];
        ...
        $data = [
            [
                'link_type_id' => \Elevate\LinkedProducts\Model\Catalog\Product\Link::LINK_TYPE_LINKEDPRODUCTS,
