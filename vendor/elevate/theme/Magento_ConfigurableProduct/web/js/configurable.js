    ...
    $.widget('mage.configurable', {
        ...
        _configureElement: function (element) {
            ...
            if (typeof(this.simpleProduct) !== 'undefined') {
                // if attribute 136??
                var id = parseInt(this.simpleProduct);
                var info = this.options.spConfig;



                var in_stock = this.options.spConfig.stockInfo[id].is_in_stock;
        ...
        // Elevate RJ -
        //https://github.com/052b-dev/magento2/commit/b7b4b2383d1b9303170d8555eafa1869978428b2
