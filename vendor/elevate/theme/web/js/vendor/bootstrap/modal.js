...
(function (global, factory) {
  ...
  var ClassName = {
    SCROLLABLE: 'bs-modal-dialog-scrollable',
    SCROLLBAR_MEASURER: 'bs-modal-scrollbar-measure',
    BACKDROP: 'bs-modal-backdrop',
    OPEN: 'bs-modal-open',
    FADE: 'fade',
    SHOW: 'show',
    STATIC: 'bs-modal-static'
  };
  var Selector = {
    DIALOG: '.bs-modal-dialog',
    MODAL_BODY: '.bs-modal-body',
    DATA_TOGGLE: '[data-toggle="bs-modal"]',
    DATA_DISMISS: '[data-dismiss="bs-modal"]',
