...
//attach a once called event handler to window
            ...
            $('.nav-toggle').on('click touchend', function (event) {
                ...
                if ($('.cd-primary-nav').hasClass('nav-is-visible')) {
                    ...
                    $('#mobile-search').addClass('is-hidden').removeClass('mobile-search-visible');
                    //open the menu
                    ev_shownav();
                    $(this).addClass('nav-is-visible');
                    $('.cd-primary-nav').removeClass('is-hidden').addClass('nav-is-visible')
            ...
            $('.cd-overlay').on('click touchend', function () {
                ev_closenavigation();
            });
        ...
        function ev_closeNav(move) {
            ...
            $('.cd-primary-nav').addClass('is-hidden').removeClass('nav-is-visible').css('-webkit-overflow-scrolling', '')
        ...
        function ev_moveNavigation() {
            ...
            if (desktop && (menu_type != 1 || !menu_type)) {
                ...
                $('#hdr-search-container').addClass('hide-on-mob');

            } else if (!desktop && (menu_type != 2 || !menu_type)) {
                menu_type = 2;
                ev_closeNav(false);
                // navigation.insertAfter('.cd-main-header');
                $('#hdr-search-container').detach().appendTo($('#mobile-search')).removeClass('hide-on-mob');
            }
        }
        ...
        function ev_opennav(event) {
            ...
            if ($('.cd-main-content').hasClass('nav-is-visible')) {
                ...
                $('.cd-primary-nav').addClass('nav-is-visible').css('-webkit-overflow-scrolling', 'touch');
