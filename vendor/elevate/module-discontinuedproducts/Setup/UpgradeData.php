...
namespace Elevate\Discontinuedproducts\Setup;
...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $data = [
            ['link_type_id' => \Elevate\Discontinuedproducts\Model\Catalog\Product\Link::LINK_TYPE_DISCONTINUEDPRODUCTS, 'code' => 'discontinuedproducts']
        ];
        ...
        $data = [
            [
                'link_type_id' => \Elevate\Discontinuedproducts\Model\Catalog\Product\Link::LINK_TYPE_DISCONTINUEDPRODUCTS,
