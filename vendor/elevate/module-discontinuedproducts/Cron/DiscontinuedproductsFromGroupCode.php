...
namespace Elevate\Discontinuedproducts\Cron;

use Symfony\Component\Console\Command\Command;
use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Output\OutputInterface;

class DiscontinuedproductsFromGroupCode extends Command
{
    ...
    {
        $this->setName('elevate:products:regeneratediscontinuedproducts')->setDescription('Regenerate Discontinued Products from Group Code');
    }
        ...
        $n = 0;
               foreach ($productCollection2 as $product2){
                    ...
                    $linkData = $productLinks //Magento\Catalog\Api\Data\ProductLinkInterface
                        ...
                        ->setLinkType('discontinuedproducts')
                        ->setPosition($n+1);
                        $n++;
