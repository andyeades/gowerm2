...
namespace Elevate\Discontinuedproducts\Model\CatalogImportExport\Import;
...
class Product extends \Magento\CatalogImportExport\Model\Import\Product
{
    ...
    protected $_linkNameToId = [
        ...
        '_discontinuedproducts_' => \Elevate\Discontinuedproducts\Model\Catalog\Product\Link::DATA_SCOPE_DISCONTINUEDPRODUCTS
    ];
    ...
    protected $_fieldsMap = [
        ...
        '_discontinuedproducts_sku' => 'discontinuedproducts_skus',
        '_discontinuedproducts_position' => 'discontinuedproducts_position',
    ];
    ...
    protected $_specialAttributes = [
        ...
        '_discontinuedproducts_sku',
        '_discontinuedproducts_position'
    ];
}
