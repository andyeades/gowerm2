...
class GoogleFeed extends Command
{
  ...
  protected $fileHandle;
    ...
    {
        $this->setName('elevate:shell:googlefeed')->setDescription('run google feed');
    }
    ...
    echo '   <a href="/google_feed.txt" download="/google_feed.txt">Download Latest Feed</a><br>';
    exit;
    ...
    protected function _getProductCollection()
    {
      ...
      $productCollection->addAttributeToFilter('type_id', array('in' => array('configurable', 'simple')));
   ...
   // $productCollection->addAttributeToFilter('sku', array('in' => array('MPL-BMBOO-BDNG-SET-KNG-WH')));                     
                            // Sample sku array
