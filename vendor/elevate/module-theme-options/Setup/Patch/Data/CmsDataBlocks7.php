...
class CmsDataBlocks7 implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function apply() {
        ...
        try {
            $this->blockRepository->getById('ev-footer-below-before-inner-content');
        } catch(NoSuchEntityException $e) {
            $cmsBlock = $this->blockInterfaceFactory->create();
            $content = '';
            $cmsBlock->setIdentifier('ev-footer-below-before-inner-content');
            $cmsBlock->setTitle('ev-footer-below-before-inner-content');
