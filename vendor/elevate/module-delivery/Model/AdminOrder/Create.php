...
namespace Elevate\Delivery\Model\AdminOrder;
...
class Create extends \Magento\Framework\DataObject implements \Magento\Checkout\Model\Cart\CartInterface
{
    ...
    public function importPostData($data)
    {
        ...
        if (isset($data['delivery_date_selected'])) {
            $this->getQuote()->setDeliveryDateSelected($data['delivery_date_selected']);
        }
        if (isset($data['detailed_delivery_info_dates'])) {
            $this->getQuote()->setDetailedDeliveryInfoDates($data['detailed_delivery_info_dates']);
        }
