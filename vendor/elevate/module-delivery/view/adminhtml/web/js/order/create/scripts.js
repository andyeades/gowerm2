...
define([
    ...
    AdminOrder.prototype = {
        ...
        setShippingMethod: function(method) {
            var data = {};
            if (method == 'deliveryoption_deliveryoption') {
                jQuery('#order-methods-additional').show();
            } else {
                jQuery('#delivery_date_selected').val('');
                jQuery('#detailed_delivery_info_dates').val('');
                jQuery('#order-methods-additional').hide();
            }
