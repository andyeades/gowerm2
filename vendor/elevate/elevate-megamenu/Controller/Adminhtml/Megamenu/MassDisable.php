 ...
 * Class MassDisable
 */
class MassDisable extends \Elevate\Megamenu\Controller\Adminhtml\Index
{
    /**
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Elevate_Megamenu::save';
  ...
  public function __construct(
    ...
    public function execute()
    {
        ...
        $this->messageManager->addSuccess(__('A total of %1 menu item(s) have been disabled.', $collection->getSize()));
