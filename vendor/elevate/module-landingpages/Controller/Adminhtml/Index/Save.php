...
class Save extends \Magento\Backend\App\Action {
    ...
    public function execute() {
        ...
        foreach ($landingAttributes as $attribute) {
            ...
            //does it already exist?
            $landing = $landingFactory->create()->getCollection()->addFieldToFilter('landingpage_landingpage_id', $id)->addFieldToFilter('landingpage_attributes_id', $landingpage_attributes_id)->addFieldToFilter('attribute_id', $attribute_id)// ->addFieldToFilter('option_id', $option_id)
                                      ->load();
