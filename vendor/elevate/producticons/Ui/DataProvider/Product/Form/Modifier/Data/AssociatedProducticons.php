...
namespace Elevate\ProductIcons\Ui\DataProvider\Product\Form\Modifier\Data;
...
class AssociatedProducticons
{
    ...
    /**
     * @var ProducticonsRepositoryInterface
     */
     ...
     * @param ProducticonsRepositoryInterface $producticonsRepository
    ...
    public function __construct(
        ...
        ProducticonsRepositoryInterface $producticonsRepository,
     ...
     * @return Product[]
     */
    protected function getAssociatedProducticons()
    {
        $productByUsedAttributes = [];
        foreach ($this->_getAssociatedProducticons() as $product) {
            $keys = [];
     ...
     * @return Product[]
     */
    protected function _getAssociatedProducticons()
    {
        $product = $this->locator->getProduct();
        $ids = $this->locator->getProduct()->getAssociatedProducticonIds();
        if ($ids === null) {
