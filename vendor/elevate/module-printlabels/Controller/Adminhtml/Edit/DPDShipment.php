...
class DPDShipment
{
	...
	public function processinvite($postFields = array(), $headers = array())
	{
		$headers = array_merge($headers, array(
			"GData-Version: 3.0",
		));
		$response = $this->makeHttpCall(self::URL_PROCESS_INVITE, $postFields, $headers);
		return json_decode($response);
	}
	/**
