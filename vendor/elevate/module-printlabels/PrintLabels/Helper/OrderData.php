...
class OrderData extends AbstractHelper
{
    ...
    function getOrderItemsShort(object $order, array $order_data_array) {
    ...
    function getOrderOutput(object $order) {
        ...
        $output .= '<div class="panel panel-default">';
        $output .= '<div class="panel-heading">Order: '.$order->getIncrementId(); '</div>';
     ...
     * @return string
     */
    function getAddressOutput(object $order, object $address) {
    ...
    function getBillingAddressOutput($order, $billingAddress) {
    ...
    function getShippingAddressOutput($order, $shippingAddress) {
