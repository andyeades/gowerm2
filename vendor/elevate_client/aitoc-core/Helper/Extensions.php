...
class Extensions extends AbstractHelper
{
    ...
    public function getAllExtensions()
    {
        ...
        if (!$data) {
            ...
            $this->cache->save(serialize($extensionsData), self::EXTENSIONS_PATH);
        }

        return unserialize($this->cache->load(self::EXTENSIONS_PATH));
    }
     ...
     * @return array|string[]
     */
    public function getInstalledAitocExtensions($restrictedDelete = false)
    {
     ...
     * @return array|string[]
     */
    private function getAllStoreExtensions()
    {
        $modules = $this->moduleList->getNames();
