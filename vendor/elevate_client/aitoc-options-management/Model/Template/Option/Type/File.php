...
class File extends DefaultType
{
    ...
    public function getFormattedOptionValue($optionValue)
    {
        if ($this->_formattedOptionValue === null) {
            $value = \Zend_Json::decode($optionValue);
            if ($value === null) {
                return $optionValue;
            }
            ...
            $this->getConfigurationItemOption()->setValue(\Zend_Json::encode($value));
        }
    ...
    {
        $unserializedValue = \Zend_Json::decode($optionValue);
    ...
    public function parseOptionValue($optionValue, $productOptionValues)
    {
        ...
        if (preg_match('/\[([0-9]+)\]/', $optionValue, $matches)) {
            ...
            if (\Zend_Json::decode($option->getValue()) !== null) {
    ...
    public function copyQuoteToOrder()
    {
        ...
        try {
            $value = \Zend_Json::decode($quoteOption->getValue());
