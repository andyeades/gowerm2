...
namespace Elevate\Assignments\Model\Data;

use Elevate\Assignments\Api\Data\AddonInterface;

class Addon extends \Magento\Framework\Api\AbstractExtensibleObject implements AddonInterface
{
    ...
    {
        return $this->_get(self::LIGHTBOX_TITLE);
    }
    ...
    {
        return $this->setData(self::LIGHTBOX_TITLE, $lightboxTitle);
    }
    ...
    {
        return $this->_get(self::LIGHTBOX_FOOTER);
    }
    ...
    {
        return $this->setData(self::LIGHTBOX_FOOTER, $lightboxFooter);
    }
