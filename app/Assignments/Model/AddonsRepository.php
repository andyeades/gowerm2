...
use Elevate\Assignments\Api\ItemsRepositoryInterface;
use Elevate\Assignments\Api\Data\ItemsSearchResultsInterfaceFactory;
...
use Elevate\Assignments\Model\ResourceModel\Items as ResourceItems;
use Elevate\Assignments\Model\ResourceModel\Items\CollectionFactory as ItemsCollectionFactory;
...
class AddonsRepository implements AddonsRepositoryInterface
{
    ...
    public function save(
        ...
        $itemsData = $this->extensibleDataObjectConverter->toNestedArray(
            $items,
            [],
            \Elevate\Assignments\Api\Data\ItemsInterface::class
        );
