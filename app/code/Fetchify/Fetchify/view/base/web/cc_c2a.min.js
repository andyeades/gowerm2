...
clickToAddress.prototype.phoneValidateCall = function (phone_number, country_code, get_network_information, success_function) {
    "use strict";
    var that = this;
    var parameters = {key: this.key, phone_number: phone_number, get_network: get_network_information};
...
clickToAddress.prototype.cacheStore = function (search, obj, sequence) {
    ...
    if (search.type === 0) {
        ...
        this.cache.finds[search.country].splice(splice_pos, 0, {query: search.query, id: search.id, response: obj, sequence: sequence});
...
clickToAddress.prototype.fillData = function (addressDataResult) {
    ...
    if (typeof this.activeDom.line_1 != "undefined") {
        ...
        if (addressData.province_code !== "" || addressData.province_name !== "") {
            var province_set = {preferred: addressData.province, code: addressData.province_code, name: addressData.province_name};
                ...
                if (matches.ids.length > 1) {
                    var characterDifferences = function (a, b) {
                        ...
                        for (var i = 0; i < a.length; i++) {
                            if (typeof aTable[a[i]] == "undefined") aTable[a[i]] = 1; else {
                                aTable[a[i]]++
                            }
                        }
                        for (var i = 0; i < b.length; i++) {
                            if (typeof bTable[b[i]] == "undefined") bTable[b[i]] = 1; else {
                                bTable[b[i]]++
                            }
                        }
                        var totalScore = 0;
...
clickToAddress.prototype.tools.defaultDiacriticsRemovalMap = [{
    ...
    base: "AU",
    letters: /[\uA736]/g
}, {base: "AV", letters: /[\uA738\uA73A]/g}, {base: "AY", letters: /[\uA73C]/g}, {
    base: "B",
    letters: /[\u0042\u24B7\uFF22\u1E02\u1E04\u1E06\u0243\u0182\u0181]/g
