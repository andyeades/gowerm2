...
class Close extends Action
{
    ...
    public function execute()
    {
        ...
        $closeBlock = $this->context->getView()->getLayout()->setIsPrivate(true)->createBlock('\Punchout2go\Punchout\Block\Close',
            'punchout.exit', array('template' => 'punchout_exit.phtml', 'cacheable' => false));
