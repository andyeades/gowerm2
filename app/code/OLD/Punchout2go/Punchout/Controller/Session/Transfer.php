...
class Transfer extends Action
{
    ...
    public function execute()
    {
        ...
        $transferBlock = $this->context->getView()->getLayout()->setIsPrivate(true)->createBlock('\Punchout2go\Punchout\Block\Transfer',
                'punchout.transfer', array('template' => 'punchout_transfer.phtml', 'cacheable' => false));

        $transferBlock->getCacheKey('punchout_transfer_' . $this->punchoutSession->getPunchoutSessionId() . '_' . uniqid());;
