...
use Elevate\Microsite\Api\Data;
use Magento\Framework\Exception\NoSuchEntityException;
use Magento\Framework\Exception\CouldNotDeleteException;
use Magento\Framework\Exception\CouldNotSaveException;

class RuleRepository implements \Elevate\Microsite\Api\RuleRepositoryInterface
{
    /**
    ...
    public function __construct(
        \Elevate\Microsite\Model\ResourceModel\Rule $ruleResource,
        \Elevate\Microsite\Model\RuleFactory $ruleFactory,
        \Elevate\Microsite\Model\Indexer\Rule\RuleProductProcessor $ruleIndexProcessor
    ) {
    ...
    public function get($ruleId)
    {
        if (!isset($this->rules[$ruleId])) {
            /** @var \Elevate\Microsite\Model\Rule $rule */
