...
use Elevate\Microsite\Model\Rule\ByPriceOptionsProvider;
use Elevate\Microsite\Model\Rule\StockStatusOptionsProvider;
 ...
 *
 * @method \Elevate\Microsite\Model\Rule setStoreIds(string $value)
 * @method \Elevate\Microsite\Model\Rule setCustomerGroupIds(string $value)
 * @method \Elevate\Microsite\Model\Rule setCategoryIds(string $value)
 * @method \Elevate\Microsite\Model\ResourceModel\Rule _getResource()
 * @method \Elevate\Microsite\Model\ResourceModel\Rule getResource()
 * @method \Elevate\Microsite\Model\Rule\Condition\Customer\Combine getActions()
 * @SuppressWarnings(PHPMD.ExcessivePublicCount)
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Rule extends \Magento\Rule\Model\AbstractModel implements \Elevate\Microsite\Api\Data\RuleInterface
{
    const CACHE_TAG = 'amsty_groupcat_rule';

    /**
     * @var \Elevate\Microsite\Model\Rule\Condition\CombineFactory
     */
     ...
     * @param \Elevate\Microsite\Model\Rule\Condition\CombineFactory                                $combineFactory
    ...
    public function __construct(
        ...
        \Elevate\Microsite\Model\Rule\Condition\Customer\CombineFactory $actionCombineFactory,
    ...
    {
        parent::_construct();
        $this->_init('Elevate\Microsite\Model\ResourceModel\Rule');
     ...
     *
     * @return \Elevate\Microsite\Model\Rule\Condition\Customer\Combine
     */
