...
use \Elevate\Microsite\Model\Rule\PriceActionOptionsProvider;
...
class ProductRuleProvider
{
    ...
    public function __construct(
        ...
        \Elevate\Microsite\Model\CustomerIdHolder $customerIdHolder
    ) {
    ...
    public function getProductPriceAction(ProductInterface $product)
    {
        ...
        return \Elevate\Microsite\Model\Rule\PriceActionOptionsProvider::SHOW;
    }
